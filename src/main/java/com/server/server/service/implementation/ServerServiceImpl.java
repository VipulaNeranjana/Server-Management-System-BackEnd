...
public class ServerServiceImpl implements ServerService {
    ...
    private String setServerImageUrl() {
        String[] imageUrls = {"https://cdn-icons-png.flaticon.com/512/3208/3208726.png",
                            "https://cdn-icons-png.flaticon.com/512/438/438599.png",
                            "https://cdn-icons-png.flaticon.com/512/188/188109.png"};
        return ServletUriComponentsBuilder.fromCurrentContextPath().path(imageUrls[new Random().nextInt(3)]).toUriString();
    }
